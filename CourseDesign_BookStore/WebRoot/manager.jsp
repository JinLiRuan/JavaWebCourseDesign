...
<style>
	...
	<body>
		...
		<h1 align="center" id="h1">钉 钉 网 上 书 城</h1>
			<div class="denglu">
				管理员：<a href="login_judge.jsp"><%=session.getAttribute("username") %></a>&nbsp;&nbsp;
				<a href="backstage.jsp">后台管理</a>&nbsp;&nbsp;
				<a href="my_cart.jsp">页面管理</a>&nbsp;&nbsp;
				<a href="${pageContext.request.contextPath}/LoginOut.jsp">退出账号</a>&nbsp;&nbsp;	
		</div>
		</div>
		</div>
